...
(function () {
  ...
  // ── Game state ─────────────────────────────────────────────────────────────
  const G = {
    mode: 'easy', phase: null, index: 0, total: 0, items: [], creature: null, creatureZ: 0,
  ...
  function doAction(a) {
    ...
    if (a.type === 'mode') { G.mode = a.mode; audio.speak(a.mode === 'easy' ? 'Easy! Tap anything!' : 'Learn! Find the letter!'); return true; }
